  ...
  describe("chart", [
    describe("area_chart", [
      it("renders with empty data", fn() {
        let el =
          chart.area_chart(data: [], width: 500, height: 300, children: [])
        el
        |> expect.to_equal(
...
pub fn series_label_tests() {
  describe("series_labels", [
    it("line with show_label renders value labels", fn() {
      ...
      let html =
        chart.line_chart(data: chart_data, width: 400, height: 300, children: [
          chart.line(config),
        ])
        |> element.to_string
    ...
    it("area with show_label renders value labels", fn() {
      ...
      let html =
        chart.area_chart(data: chart_data, width: 400, height: 300, children: [
          chart.area(config),
        ])
        |> element.to_string
...
pub fn polar_grid_fill_tests() {
  describe("polar_grid_fill", [
    ...
    it("fill renders in polar grid SVG", fn() {
      ...
      let html =
        chart.radar_chart(data: data, width: 400, height: 300, children: [
          chart.polar_grid(
